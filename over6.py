...
df.drop(['elo_prob1', 'elo_prob2', 'season', 'neutral', 'playoff', 'elo1_post', 'elo2_post', 'pitcher1', 'pitcher2',
         'rating1_post', 'rating2_post', ], axis=1, inplace=True)

# print(len(df))
# df
df = df[(df['date'] >= '2022-05-16') & (df['date'] < '2022-05-17')].copy()
...
model = load('random_forest_baseball_history.joblib')
...
num_cols = ['elo1_pre', 'elo2_pre', 'rating1_pre', 'rating2_pre', 'pitcher1_rgs', 'pitcher2_rgs', 'pitcher1_adj',
            'pitcher2_adj', 'rating_prob1', 'rating_prob2', 'Real results']
